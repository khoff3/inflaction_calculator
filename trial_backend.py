...
def get_best_match_name(player_full_name):
    name_corrections = {
        "DJ Moore": "D.J. Moore",
        "Patrick Mahomes II": "Patrick Mahomes"
    }
    corrected_name = name_corrections.get(player_full_name, player_full_name)
    best_match, score = process.extractOne(corrected_name, expected_values["Player"])
...
def calculate_inflation_rates(draft_data):
    ...
    rankings = {
        "QB": pd.read_csv('C:\\Users\\lasab\\Downloads\\FantasyPros_2023_Draft_QB_Rankings (2).csv'),
        "RB": pd.read_csv('C:\\Users\\lasab\\Downloads\\FantasyPros_2023_Draft_RB_Rankings (1).csv'),
        "WR": pd.read_csv('C:\\Users\\lasab\\Downloads\\FantasyPros_2023_Draft_WR_Rankings (1).csv'),
        "TE": pd.read_csv('C:\\Users\\lasab\\Downloads\\FantasyPros_2023_Draft_TE_Rankings (1).csv')
    }
...
def get_inflation_rate():
    ...
    print("Data being sent to frontend:", tiered_inflation)
